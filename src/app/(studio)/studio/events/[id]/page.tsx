    ...
    <div className="max-w-4xl mx-auto space-y-8 pb-20 animate-fade-in-up">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 pb-6 border-b border-slate-800/80">
        <div className="flex items-center gap-4">
          <Link
            href="/studio"
            className="p-3 bg-slate-900 border border-slate-800 rounded-2xl hover:bg-slate-800 hover:border-orange-500/50 transition-all group"
          >
        ...
        <div className="flex flex-wrap items-center gap-3">
          <Link
            ...
            className="flex items-center gap-2 px-4 py-2.5 bg-orange-500/10 hover:bg-orange-500/20 border border-orange-500/30 text-orange-400 text-xs font-bold rounded-xl transition-all shadow-inner"
          >
            <Users className="w-4 h-4" /> Guest List ({totalTicketsSold})
          </Link>
          <Link
            href={`/studio/events/${event.id}/scanner`}
            className="flex items-center gap-2 px-4 py-2.5 bg-amber-500/10 hover:bg-amber-500/20 border border-amber-500/30 text-amber-400 text-xs font-bold rounded-xl transition-all shadow-inner"
          >
            <QrCode className="w-4 h-4" /> Scanner
          </Link>
          <Link
            href={`/studio/events/${event.id}/finance`}
            className="flex items-center gap-2 px-4 py-2.5 bg-emerald-500/10 hover:bg-emerald-500/20 border border-emerald-500/30 text-emerald-400 text-xs font-bold rounded-xl transition-all shadow-inner"
          >
            <Wallet className="w-4 h-4" /> Payouts
          </Link>
          <Link
            href={`/studio/events/${event.id}/staff`}
            className="flex items-center gap-2 px-4 py-2.5 bg-slate-800 hover:bg-slate-700 border border-slate-700 hover:border-slate-600 text-slate-300 text-xs font-bold rounded-xl transition-all shadow-inner"
          >
